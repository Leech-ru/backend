...
func (nq *NewsQuery) Order(o ...news.OrderOption) *NewsQuery {
...
func (nq *NewsQuery) All(ctx context.Context) ([]*News, error) {
	...
	return withInterceptors[[]*News](ctx, nq, qr, nq.inters)
}
...
func (nq *NewsQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (nq *NewsQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, nq, querierCount[*NewsQuery](), nq.inters)
}
...
func (nq *NewsQuery) Clone() *NewsQuery {
	...
	return &NewsQuery{
		config:     nq.config,
		ctx:        nq.ctx.Clone(),
		order:      append([]news.OrderOption{}, nq.order...),
...
func (nq *NewsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(news.Table, news.Columns, sqlgraph.NewFieldSpec(news.FieldID, field.TypeUUID))
	_spec.From = nq.sql
...
func (ngb *NewsGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*NewsQuery, *NewsGroupBy](ctx, ngb.build, ngb, ngb.build.inters, v)
}

func (ngb *NewsGroupBy) sqlScan(ctx context.Context, root *NewsQuery, v any) error {
...
func (ns *NewsSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*NewsQuery, *NewsSelect](ctx, ns.NewsQuery, ns, ns.inters, v)
}

func (ns *NewsSelect) sqlScan(ctx context.Context, root *NewsQuery, v any) error {
