...
func (e ImageEdges) CosmeticsOrErr() ([]*Cosmetics, error) {
	if e.loadedTypes[0] {
...
// QueryCosmetics queries the "cosmetics" edge of the Image entity.
func (i *Image) QueryCosmetics() *CosmeticsQuery {
	return NewImageClient(i.config).QueryCosmetics(i)
}
