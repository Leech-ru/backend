...
func (ic *ImageCreate) AddCosmeticIDs(ids ...uuid.UUID) *ImageCreate {
	ic.mutation.AddCosmeticIDs(ids...)
	return ic
}

// AddCosmetics adds the "cosmetics" edges to the Cosmetics entity.
func (ic *ImageCreate) AddCosmetics(c ...*Cosmetics) *ImageCreate {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return ic.AddCosmeticIDs(ids...)
}
...
func (ic *ImageCreate) createSpec() (*Image, *sqlgraph.CreateSpec) {
	...
	if nodes := ic.mutation.CosmeticsIDs(); len(nodes) > 0 {
