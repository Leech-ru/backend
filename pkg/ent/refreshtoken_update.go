...
func (rtu *RefreshTokenUpdate) SetJti(s string) *RefreshTokenUpdate {
	rtu.mutation.SetJti(s)
	return rtu
}

// SetNillableJti sets the "jti" field if the given value is not nil.
func (rtu *RefreshTokenUpdate) SetNillableJti(s *string) *RefreshTokenUpdate {
	if s != nil {
		rtu.SetJti(*s)
	}
	return rtu
...
func (rtu *RefreshTokenUpdate) check() error {
	if v, ok := rtu.mutation.Jti(); ok {
		if err := refreshtoken.JtiValidator(v); err != nil {
			return &ValidationError{Name: "jti", err: fmt.Errorf(`ent: validator failed for field "RefreshToken.jti": %w`, err)}
		}
	}
...
func (rtu *RefreshTokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := rtu.mutation.Jti(); ok {
		_spec.SetField(refreshtoken.FieldJti, field.TypeString, value)
	}
...
// SetJti sets the "jti" field.
func (rtuo *RefreshTokenUpdateOne) SetJti(s string) *RefreshTokenUpdateOne {
	rtuo.mutation.SetJti(s)
	return rtuo
}

// SetNillableJti sets the "jti" field if the given value is not nil.
func (rtuo *RefreshTokenUpdateOne) SetNillableJti(s *string) *RefreshTokenUpdateOne {
	if s != nil {
		rtuo.SetJti(*s)
	}
	return rtuo
...
func (rtuo *RefreshTokenUpdateOne) sqlSave(ctx context.Context) (_node *RefreshToken, err error) {
	...
	if value, ok := rtuo.mutation.Jti(); ok {
		_spec.SetField(refreshtoken.FieldJti, field.TypeString, value)
	}
