...
type CategoryEdges struct {
	// Cosmetics holds the value of the cosmetics edge.
...
// CosmeticsOrErr returns the Cosmetics value or an error if the edge
// was not loaded in eager-loading.
func (e CategoryEdges) CosmeticsOrErr() ([]*Cosmetics, error) {
	if e.loadedTypes[0] {
		return e.Cosmetics, nil
	}
	return nil, &NotLoadedError{edge: "cosmetics"}
}
...
// QueryCosmetics queries the "cosmetics" edge of the Category entity.
func (c *Category) QueryCosmetics() *CosmeticsQuery {
	return NewCategoryClient(c.config).QueryCosmetics(c)
}
