...
func (cc *CategoryCreate) AddCosmeticIDs(ids ...uuid.UUID) *CategoryCreate {
	cc.mutation.AddCosmeticIDs(ids...)
	return cc
}

// AddCosmetics adds the "cosmetics" edges to the Cosmetics entity.
func (cc *CategoryCreate) AddCosmetics(c ...*Cosmetics) *CategoryCreate {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return cc.AddCosmeticIDs(ids...)
}
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.CosmeticsIDs(); len(nodes) > 0 {
